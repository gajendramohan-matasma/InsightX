...
import type { RechartsLineProps } from "@/lib/utils/chart-mapper";

interface LineChartComponentProps {
  config: RechartsLineProps;
  height?: number;
}

export function LineChartComponent({ config, height = 300 }: LineChartComponentProps) {
  return (
    <ResponsiveContainer width="100%" height={height}>
      <RechartsLineChart data={config.data} margin={{ top: 5, right: 20, left: 10, bottom: 5 }}>
